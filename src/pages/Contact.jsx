...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: 'Phone Numbers',
      details: [
        '+94 37 433 1659 (Office)',
        '+94 76 753 1659 (Mobile)',
        '+94 71 531 6597 (Support)',
      ],
    },
    {
      icon: (
            ...
            <div>
              <div className="bg-gray-200 rounded-xl h-64 mb-6 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-gray-500">
                    No. 54/1, Wilbagedara, Bandarakoswaththa, Sri Lanka
                  </p>
                  <a
                    href="https://maps.app.goo.gl/JPSkzWAM9fUujiuy9"
                    target="_blank"
              ...
              <div className="bg-primary-50 p-6 rounded-xl">
                ...
                <p className="text-gray-600 mb-4">
                  We value your time. Our team is committed to responding to all inquiries within 24 business hours.
                </p>
